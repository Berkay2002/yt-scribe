...
For OpenCode-specific command details, follow `skills/yt-scribe/harness/opencode.md` in this repository when it is available. The inner polishing skill lives at `.agents/skills/yt-scribe-transcript-polisher`.
